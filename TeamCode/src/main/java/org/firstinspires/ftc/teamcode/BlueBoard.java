...
@Autonomous(name = "Blue Board-Side", group = "Autonomous")
// @Disabled
public class BlueBoard extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    while (opModeIsActive()) {
      ...
      robot.encoderDrive(0.4, -639, -404, -612, -645);
      robot.encoderDrive(0.4, 707, -466, -825, 870);
      robot.encoderDrive(0.4, -616, -409, -574, -628);
      ...
      sleep(5000);
      robot.encoderDrive(0.4, -437, -320, -434, -464);
